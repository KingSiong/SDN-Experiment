...
class GeneratedTopo( Topo ):
    ...
    def __init__( self, **opts ):
        ...
        self.addLink( s1 , s25, bw=1000, delay='50ms')
        self.addLink( s1 , s23, bw=1000, delay='34ms')
        self.addLink( s2 , s3, bw=1000, delay='13ms')
        self.addLink( s2 , s5, bw=1000, delay='14ms')
        self.addLink( s3 , s4, bw=1000, delay='15ms')
        self.addLink( s4 , s11, bw=1000, delay='12ms')
        self.addLink( s4 , s6, bw=1000, delay='17ms')
        self.addLink( s5 , s8, bw=1000, delay='10ms')
        self.addLink( s7 , s25, bw=1000, delay='18ms')
        self.addLink( s7 , s16, bw=1000, delay='17ms')
        self.addLink( s8 , s17, bw=1000, delay='13ms')
        self.addLink( s9 , s22, bw=1000, delay='14ms')
        self.addLink( s9 , s16, bw=1000, delay='19ms')
        self.addLink( s10 , s18, bw=1000, delay='14ms')
        self.addLink( s10 , s14, bw=1000, delay='15ms')
        self.addLink( s11 , s24, bw=1000, delay='17ms')
        self.addLink( s12 , s18, bw=1000, delay='40ms')
        self.addLink( s12 , s23, bw=1000, delay='44ms')
        self.addLink( s13 , s20, bw=1000, delay='15ms')
        self.addLink( s13 , s21, bw=1000, delay='18ms')
        self.addLink( s13 , s15, bw=1000, delay='15ms')
        self.addLink( s14 , s21, bw=1000, delay='19ms')
        self.addLink( s15 , s22, bw=1000, delay='15ms')
        self.addLink( s16 , s17, bw=1000, delay='12ms')
        self.addLink( s18 , s19, bw=1000, delay='44ms')
        self.addLink( s19 , s20, bw=1000, delay='48ms')
        self.addLink( s22 , s23, bw=1000, delay='16ms')
        self.addLink( s24 , s25, bw=1000, delay='13ms')
